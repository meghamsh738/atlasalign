...
/** Immutable temporary intensity features on one Allen 25 µm plane grid. */
public final class C01FeatureGrid {
    ...
    public C01FeatureGrid(
        ...
        if (width <= 0 || height <= 0
            ...
            throw new IllegalArgumentException(
                    "C01 feature pixels must match positive dimensions");
        }
        this.width = width;
        this.height = height;
